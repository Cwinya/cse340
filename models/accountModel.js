...
async function getAccountByEmail (account_email) {
    try {
        ...
        // Log the actual error but throw a generic one
...
async function updateAccount(account_firstname, account_lastname, account_email, account_id){
    try {
        ...
        // Log error and return null to indicate update failure
...
async function changePassword(account_password, account_id){
    try {
        ...
        // Log error and return false to indicate password update failure
        console.error("changePassword model error: " + error)
        return false
    }
}
